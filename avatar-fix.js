...
function paintAvatar(selector, name, avatarUrl) {
  ...
  const avatar = avatarUrl || DEFAULT_AVATAR_URL;
  element.textContent = "";

  element.style.setProperty("background-image", `url("${avatar}")`, "important");
  element.style.setProperty("background-size", avatarUrl ? "cover" : "contain", "important");
  element.style.setProperty("background-position", "center", "important");
  element.style.setProperty("background-repeat", "no-repeat", "important");
  element.style.setProperty("background-color", avatarUrl ? "transparent" : "#fff", "important");
}
